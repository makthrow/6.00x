...
def updateHand(hand, word):
    ...
    for l in word:
        if updatedhand.get(l, 0) != 0:
            updatedhand[l] -= 1
    #print "hand: %s" % hand
    #print "updatedhand: %s" % updatedhand
    return updatedhand
...
def isValidWord(word, hand, wordList):
    ...
    """
    handcopy = hand.copy()
    # check word is made of letters in hand
    for l in word:
        if l in handcopy and handcopy[l] > 0:
            handcopy[l] -= 1
        else:
            return False
    # check word is in wordlist
    ...
    while lettersLeft > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalscore += score
                print "%r earned %d points. Total: %d points" % (userWord, score, totalscore)
                print
